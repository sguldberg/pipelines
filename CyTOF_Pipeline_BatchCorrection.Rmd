...
wd = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/pre_processing/raw/normed/beads_removed/debarcoded_all"
setwd(wd)
...
```{r}
wd = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/pre_processing/raw/normed/beads_removed/debarcoded_all/relabeled"
setwd(wd)
...
data_dir <- "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/batch_correction/fcs_leukocytes"
path_panel <- "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/batch_correction/E035_panel_Leuk.xlsx"
path_metdata<-"/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/batch_correction/E035_sample_metadata.xlsx"
panel <- read_excel(path_panel)
metadata<- read_excel(path_metdata)
...
uncorrected <- prepare_data(data_dir = data_dir,
                           ...
                           # condition = "condition", # column in metadata
                            ...
                            # sample_size = 500000,
                             seed = 1234,
                             cofactor = 5) 
saveRDS(uncorrected, file = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/batch_correction/cycombine_raw_uncorrected.RDS")
```
...
```{r}
detect_batch_effect_express(uncorrected, downsample = 10000, out_dir = '/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/batch_correction/batch_effect_check')
```
...
corrected <- uncorrected %>%
  batch_correct(markers = markers,
               ...
               # covar = "condition",
                anchor = "anchor")
saveRDS(corrected, file = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/batch_correction/cycombine_raw_corrected.RDS")
```
...
```{r}
run_analysis(tool = "cycombine", data = "raw", data_dir = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/batch_correction", markers = markers)
```
...
sce2FCS(sce, split_by = "sample_id", assay = "counts", randomize = TRUE, outdir = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/batch_correction/batch_corrected_fcs")
```
...
Load metadata file
```{r}
path_md <- "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/CATALYST/E035_metadata_Leuk.xlsx"
md <- read_excel(path_md)
head(data.frame(md))
```

Load pre-processed FCS files. Move any norm control samples into a different folder to prevent them being added to your SCE
```{r}
#read in FCS files as flowSet
path_fcs<- "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/batch_correction/batch_corrected_fcs"
...
path_panel <- "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/CATALYST/E035_panel_Leuk_Catalyst.xlsx"
panel <- read_excel(path_panel)
...
spillover<-data.frame(read_excel("/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/CATALYST/cytof_spillover_matrix_wDi.xlsx"))
...
for (id in ids) {
    ...
    fn <- file.path("/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/CATALYST/comp_fcs", fn)         # construct output path
...
```{r}
# Save the sce object
saveRDS(sce, file = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/CATALYST/objects/sce_comp.rds")

# Read the object back in allowing you to start your analysis from here and skip the compensation steps
#sce<-readRDS(file = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/CATALYST/objects/sce_comp.rds")
```
...
```{r}
# Save the sce object
saveRDS(sce, file = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/CATALYST/objects/sce_comp_clust_DR.rds")

# Read the object back in allowing you to start your analysis from here and skip the compensation steps
#sce<-readRDS(file = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/CATALYST/objects/sce_comp_clust_DR.rds")
```
...
```{r}
#merging on the sce
merging_table <- read_excel("/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/CATALYST/cluster_merging_meta20_Leuk.xlsx")
...
```{r}
# Save the sce object
saveRDS(sce, file = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/CATALYST/objects/sce_comp_clust_DR_anno.rds")

# Read the object back in allowing you to start your analysis from here and skip the compensation steps
#sce<-readRDS(file = "/Users/sguldberg/Box Sync/CyTOF_pipeline_test_data_full_analysis/analysis/CATALYST/objects/sce_comp_clust_DR_anno.rds")
```
